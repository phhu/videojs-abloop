  	...
  	//this plugin provides AB loop functionality
  	//It has no user interface - just an API...
  	videojs.plugin('abLoopPlugin', function (initialOptions) {
		...
		api.setToInitialOptions = setOptionsToInitialOptions;
		api.setOptions = setOptions;
		api.goToStartOfLoop = goToStartOfLoop;
		api.goToEndOfLoop = goToEndOfLoop;	
		api.setStartOfLoop = setStartOfLoop;
		api.setEndOfLoop = setEndOfLoop;
